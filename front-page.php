							...
							?>
								...
								<div class="post-text">
									...
									<a href="<?php echo get_the_permalink() ?>" class="more">Читать далее
										<!-- <svg width="15" height="7" fill="#fff">
								...
								switch($cn) {
									case '1':
											?>
												...
												<div class="center">
													<div class="item-1">
														<a href="<?php the_permalink() ?>" class="other-post">
															<h4 class="title"><?php echo mb_strimwidth(get_the_title(), 0, 25, '...') ?></h4>										
															<p class="excerpt"><?php echo mb_strimwidth(get_the_excerpt(), 0, 50, '...') ?></p>
															<span class="date"><?php the_time('j F Y') ?></span>
														</a>
													</div>
												</div>
