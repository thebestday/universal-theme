				...
				<div class="video">					
					<div class="video">
						<?php
							...
							$youtu = explode('.be/', $video_link);
							$vimeo = explode('vimeo.com/', $video_link);
						
							if (strpos($video_link, 'youtu.be') !== false) {
								?>    
									<iframe width="100%" height="450" src="https://www.youtube.com/embed/<?php echo end($youtu); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay;         clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
									</iframe>
								<?php
